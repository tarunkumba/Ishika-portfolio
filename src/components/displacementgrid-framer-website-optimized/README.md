# displacementgrid-framer-website

A Next.js project generated from [https://displacementgrid.framer.website/style-2](https://displacementgrid.framer.website/style-2) by [FNJ](https://framertonextjs.com).

## What this is

4 page(s) built from 30 React section component(s). Unlike a
