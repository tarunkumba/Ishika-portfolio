...
/** Generated from the Framer section "Container (Default3)".
...
export default function Default3() {
  return (
    <div className="ssr-variant hidden-165yzti">
      <div className="framer-15mj0qu-container">
        <Suspense fallback={null}>
          <a className="framer-ryTVy framer-1vf0tn3 framer-v-1vf0tn3 framer-qfn3yv" data-border="true" data-framer-name="default" href={copy.linkStyle3} style={{ "--border-bottom-width": "1px", "--border-color": "rgba(255, 255, 255, 0)", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", "--corner-shape-fallback": "0.71", backdropFilter: "blur(42px)", background: "linear-gradient(180deg, rgba(209, 232, 255, 0) 0%, rgba(39, 49, 77, 0) 100%)", backgroundColor: "rgba(0, 0, 0, 0)", cornerShape: "superellipse(1.6)", WebkitBackdropFilter: "blur(42px)", borderBottomLeftRadius: "calc(16px*var(--one-if-corner-shape-supported,var(--corner-shape-fallback,1)))", borderBottomRightRadius: "calc(16px*var(--one-if-corner-shape-supported,var(--corner-shape-fallback,1)))", borderTopLeftRadius: "calc(16px*var(--one-if-corner-shape-supported,var(--corner-shape-fallback,1)))", borderTopRightRadius: "calc(16px*var(--one-if-corner-shape-supported,var(--corner-shape-fallback,1)))", boxShadow: "inset 0px 0px 9px -3px rgba(255, 255, 255, 0), 0px 0.421531111242075px 0.37937800011786743px -1.5px rgba(0, 0, 0, 0), 0px 1.60197331227042px 1.4417759810433777px -3px rgba(0, 0, 0, 0), 0px 7px 6.299999999999999px -4.5px rgba(0, 0, 0, 0)" }}>
