...
import Container from "@/src/sections/style-2/Container";

/** The "/style-2" page, composed from its Framer sections.
 *
...
export default function Style2Page() {
  return (
    <body>
      ...
      {"\n\t\n\t"}
      <div id="main" data-framer-hydrate-v2={"{\"routeId\":\"cLGSCzupE\",\"localeId\":\"default\",\"breakpoints\":[{\"hash\":\"vzk4jb\",\"mediaQuery\":\"(min-width: 1920px)\"},{\"hash\":\"n19bdk\",\"mediaQuery\":\"(min-width: 810px) and (max-width: 1919.98px)\"},{\"hash\":\"165yzti\",\"mediaQuery\":\"(max-width: 809.98px)\"}]}"} data-framer-ssr-released-at="2026-05-12T14:28:04.547Z" data-framer-page-optimized-at="2026-05-14T22:32:07.454Z" data-framer-generated-page="">
        <Suspense fallback={null}>
          <style data-framer-html-style="" dangerouslySetInnerHTML={{ __html: "html body { background: rgb(10, 10, 10); }" }} />
          <div data-framer-root="" className="framer-do26i framer-vzk4jb" style={{ minHeight: "100vh", width: "auto" }}>
            <Container />
          </div>
          <div id="overlay" />
        </Suspense>
